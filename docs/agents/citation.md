...
> *agentic-telemetry-spec* — JSON Schema specification for metadata on agentic AI tool calls
> (version 0.1.0). Jonathan A. Bowe, 2026.
> Licensed Apache-2.0. <https://github.com/jonathan-kellerai/agentic-telemetry-spec>
...
@misc{dgm-telemetry2026,
  ...
  title        = {{agentic-telemetry-spec: JSON Schema specification for agentic AI
                   tool-call metadata (provenance, A/B testing, KoTH/Oracle
                   attribution, decision logging, backward-compatible migration)}},
  year         = {2026},
  version      = {0.1.0},
  howpublished = {\url{https://github.com/jonathan-kellerai/agentic-telemetry-spec}},
...
`agentic-telemetry-spec 0.1.0` — always include the version number.
...
> agentic-telemetry-spec `schemas/goals/provenance.schema.json` (Goal 1 — Provenance), version 0.1.0.
> <https://github.com/jonathan-kellerai/agentic-telemetry-spec>
...
> *agentic-telemetry-spec Design Goals* (v0.1.0). Jonathan A. Bowe.
> `docs/design-goals.md`.
> <https://github.com/jonathan-kellerai/agentic-telemetry-spec>

## Attribution in source code

When embedding agentic-telemetry-spec schemas in a pipeline or ingestor, add a comment block:

```python
# Metadata schema: agentic-telemetry-spec v0.1.0 — Apache-2.0
# https://github.com/jonathan-kellerai/agentic-telemetry-spec
```
